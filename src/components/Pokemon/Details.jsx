...
function PokemonDetails(props) {
    ...
    const _GifCard = () => {
        ...
        return (<>
            <p className='details-pokemon-name'>
                { pokemon.name }
            </p>

            <div id='details-sprites' style={style}> {
                ...
                <div className='section details-overview'>
                    ...
                    <div className='details-stats'>
                        <div style={{ display: 'flex' }}>
                            ...
                            <Slider min={1} max={100} step={1} className='details-level-slider'
                        ...
                        { showStatBars
                            ...
                            :   <div className='details-stats-text'>
                                    { pokemon.stats.map((stat, i) =>
                                        <Stat key={i} stat={stat} level={level} />
                                    )}
                                </div>
                        }
                    </div>
    ...
    return (
        <Container id='details-pokemon' style={{ backgroundColor: styles.colors ? styles.colors[0].light : '#FFF' }}>
            { fetching  ? <p>Fetching</p> : _FullPokemon() }
        </Container>
    )
}
